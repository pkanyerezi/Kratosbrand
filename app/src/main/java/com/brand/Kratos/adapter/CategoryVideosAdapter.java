...
public class CategoryVideosAdapter extends RecyclerView.Adapter<CategoryVideosAdapter.MyViewHolder>{
    ...
    public CategoryVideosAdapter(Context mainActivityContacts, List<Data> videolist) {
        this.videolist = videolist;
        this.mcontext = mainActivityContacts;
    }

    @Override
    public CategoryVideosAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_category_video, parent, false);


        return new CategoryVideosAdapter.MyViewHolder(itemView);


    }

    @Override
    public void onBindViewHolder(CategoryVideosAdapter.MyViewHolder holder, int position) {
