...
public class SettingsFrag extends Fragment {
    ...
    MyTextView_Roboto_Regular user_name;
    MyTextView_Roboto_Regular email_id;
    LinearLayout check_tags;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      View v = inflater.inflate(R.layout.fragment_settings, container, false);
        ...
        check_tags = v.findViewById(R.id.check_tags);
        logout_id = v.findViewById(R.id.logout_id);
        user_name.setText(full_name);
        email_id.setText(email);
        check_tags.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), MyTags.class);
