...
import com.brand.Kratos.adapter.LiveVideosAdaptor;
...
public class LiveVideos extends Fragment {
    ...
    public static String type = "LIVE-STREAM";
    ...
    private RecyclerView recycler_live;
      LiveVideosAdaptor liveVideosAdaptor;
    SwipeRefreshLayout swipeRefreshLayout_live;
     ...
     * @return A new instance of fragment LiveVideos.
     */
    // TODO: Rename and change types and number of parameters
    public static LiveVideos newInstance(String param1, String param2) {
        LiveVideos fragment = new LiveVideos();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_live_videos, container, false);
        swipeRefreshLayout_live = v.findViewById(R.id.swipeRefreshLayout_live);
        recycler_live = v.findViewById(R.id.recycler_live);
        context=getActivity();
        flayoutManager = new LinearLayoutManager(getContext());
        recycler_live.setLayoutManager(flayoutManager);
        swipeRefreshLayout_live.setRefreshing(true);
    ...
    public void loadcontent(String category, final int page_no, int limit, String code, String type, String search, String sort, String direction){
        ...
        call.enqueue(new Callback<ResponseContent>() {
            ...
            public void onResponse(Call<ResponseContent> call, Response<ResponseContent> response) {
                ...
                swipeRefreshLayout_live.setRefreshing(false);
                if(response.isSuccessful()){
                    ...
                    if(page_no >1){
                        ...
                        liveVideosAdaptor.swap(response.body().getData());
                        //fAdapter.notifyDataSetChanged(); // or notifyItemRangeRemoved
                        // 3. Reset endless scroll listener when performing a new search
                        // scrollListener.resetState();
                    }else{
                        liveVideosAdaptor = new LiveVideosAdaptor(context,response.body().getData());
                        recycler_live.setAdapter(liveVideosAdaptor);
                    }
